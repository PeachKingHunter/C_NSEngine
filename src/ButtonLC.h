...
ButtonLC *createButton(int sizeX, int sizeY, char *name, char **text, FilePiece **onClickScript, Line **callLine, int *colorButton, int *backgroundButton, int *textColor, int textSize);
